...
public class EncryptController {
	...
	private static final String SECRET_KEY = "SuperSecretKey12"; // harus 16 bytes (AES-128)

	@PostMapping("/auth")
	public void encrypt(@RequestBody AuthDto authDto){

		log.info("password {} " ,authDto);
		String password = decrypt(authDto.getPassword());
		log.info("Password hasil : {} " , password);
	}
